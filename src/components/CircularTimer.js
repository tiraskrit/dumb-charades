  ...
  return (
    <div style={{ position:"relative", width:140, height:140 }}>
      ...
      <div style={{
        ...
        <span style={{ fontSize:36, fontWeight:800, color, fontFamily:"'Bebas Neue',sans-serif", letterSpacing:2 }}>
          {pad(Math.floor(timeLeft/60))}:{pad(timeLeft%60)}
        </span>
        <span style={{ fontSize:11, color:"rgba(255,255,255,0.45)", fontFamily:"'DM Sans',sans-serif", letterSpacing:1 }}>

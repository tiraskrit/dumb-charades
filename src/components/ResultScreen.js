...
export default function ResultScreen({ result, onRestart }) {
  ...
  return (
    <div className="result-container" style={{
      ...
      {/* Final scores */}
      <div className="final-scores" style={{ display:"flex", gap:24, marginBottom:48 }}>
        {teams.map((t, i) => (
          <div key={i} className="score-card-item" style={{
      ...
      <button className="start-button" onClick={onRestart} style={{
